...
def on_closing():
    if mess.askyesno("Quit", "Do you want to quit?"):
        window.destroy()
def contact():
    mess._show(title="Contact Me",message="If you find anything weird then feel free to contact me on 'surajkkns@gmail.com'")

def about():
    mess._show(title="About",message="This Attendance System is designed by Suraj kr Suman")
...
window = tkinter.Tk()
window.title("Face Recognition Based Attendance System (frbas)")
...
lbl = tkinter.Label(frame1, text="Enter Regn Id",width=20  ,height=1  ,fg="black"  ,bg="white" ,font=('times', 17, ' bold ') )
lbl.place(x=0, y=55)
